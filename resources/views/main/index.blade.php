...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('mai/img/favicon.ico')}}">
    ...
    <link rel="stylesheet" href="{{asset('main/css/animated-headline.css')}}">
...
<body>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <a href="index.html"><img src="{{asset('main/img/logo/logo.png')}}" alt=""></a>
                            </div>
                        </div>
    ...
    <main>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="about-img ">
                            <div class="about-font-img d-none d-lg-block">
                                <img src="{{asset('main/img/gallery/about2.png')}}" alt="">
                            </div>
                            <div class="about-back-img ">
                                <img src="{{asset('main/img/gallery/about1.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-lg-5">
                                    <div class="dept_thumb">
                                        <img src="{{asset('main/img/gallery/department_man.png')}}" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- single_content  -->
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img big-img" style="background-image: url({{asset('main/img/gallery/gallery1.png')}});"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url({{asset('main/img/gallery/gallery2.png')}});"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url({{asset('main/img/gallery/gallery3.png')}});"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url({{asset('main/img/gallery/gallery4.png')}});"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img small-img" style="background-image: url({{asset('main/img/gallery/gallery5.png')}});"></div>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="single-gallery mb-30">
                                    <div class="gallery-img big-img" style="background-image: url({{asset('main/img/gallery/gallery6.png')}});"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="single-testimonial text-center">
                        ...
                        <div class="testimonial-caption ">
                            <div class="testimonial-top-cap">
                                <img src="{{asset('main/img/gallery/testimonial.png')}}" alt="">
                            ...
                            <div class="testimonial-founder d-flex align-items-center justify-content-center">
                                <div class="founder-img">
                                    <img src="{{asset('main/img/gallery/Homepage_testi.png')}}" alt="">
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('main/img/gallery/team3.png')}}" alt="">
                            </div>
                            <div class="team-caption">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            <div class="team-img">
                                <img src="{{asset('main/img/gallery/team1.png')}}" alt="">
                            </div>
                            <div class="team-caption">
        ...
        <div class="contact-form-main">
            ...
            <div class="from-left d-none d-lg-block">
                <img src="{{asset('main/img/gallery/contact_form.png')}}" alt="">
            </div>
        </div>
        <!-- Contact form End -->
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url({{asset('main/img/gallery/gallery1.png')}});"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url({{asset('main/img/gallery/gallery2.png')}});"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url({{asset('main/img/gallery/gallery3.png')}});"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url({{asset('main/img/gallery/gallery4.png')}});"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url({{asset('main/img/gallery/gallery5.png')}});"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="gallery-box">
                            <div class="single-gallery">
                                <div class="gallery-img " style="background-image: url({{asset('main/img/gallery/gallery6.png')}});"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{asset('main/img/gallery/blog1.png')}}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Health</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{asset('main/img/gallery/blog2.png')}}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Checkup</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-blogs mb-30">
                            <div class="blog-img">
                                <img src="{{asset('main/img/gallery/blog3.png')}}" alt="">
                            </div>
                            <div class="blogs-cap">
                                <div class="date-info">
                                    <span>Operation</span>
    ...
    <footer>
        <!--? Footer Start-->
        <div class="footer-area section-bg" data-background="{{asset('main/img/gallery/footer_bg.jpg')}}">
            <div class="container">
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{asset('main/img/logo/logo2_footer.png')}}" alt=""></a>
                                </div>
                            </div>
                        </div>
    ...
    <script src="{{asset('main/js/animated.headline.js')}}"></script>
